...
const SideNavBottomMenu = ({ onFileCreate, length }: any) => {
  const menuList = [
    { id: 1, name: "Getting Started", icon: FlagIcon, link: "/dashboard/getting-started" },
    { id: 2, name: "Github Sync", icon: Github, link: "/dashboard" },
    { id: 3, name: "Private Files", icon: LucideLock, link: "/dashboard" },
    { id: 4, name: "Archive", icon: ArchiveIcon, link: "/dashboard/archive" }, // Update link
  ];
